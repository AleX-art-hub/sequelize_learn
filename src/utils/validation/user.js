...
export default Joi.object({
    firstName: nameSchema.label('First name').when('$isCreateMode', {then: nameSchema.required() }),
    lastName: nameSchema.label('Last name').when('$isCreateMode', {then: nameSchema.required() }),
